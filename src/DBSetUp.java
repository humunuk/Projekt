...
public class DBSetUp {
    ...
    public DBSetUp(String curriculumName, String curriculumPath) {
        ...
        try {
            ...
            statement.executeUpdate("create table if not exists plans (id integer primary key asc, name string)");
            statement.executeUpdate("create table if not exists plan_subjects (id integer primary key asc, plan_id integer, subject_id integer, year integer, vota integer, foreign key (plan_id) references plans(id), foreign key (subject_id) references subjects(id))");
            try {
